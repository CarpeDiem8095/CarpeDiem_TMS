...
VALUES('user5@naver.com','USER','USER','U','N',SYSDATE);
...
CREATE TABLE REPORTBOARD (
	SEQ NUMBER NOT NULL,
	REPORTER_EMAIL VARCHAR2(50) NOT NULL,
	SUBJECT_EMAIL VARCHAR2(50) NOT NULL,
...
-- CP55241 신고 양식 작성
-- 신고글 입력
INSERT INTO REPORTBOARD(SEQ, REPORTER_EMAIL, SUBJECT_EMAIL, REPORT_TYPE, CONTENT, TEXT_REGDATE, BOARD_TYPE)
VALUES(REPORTBOARD_SEQ.NEXTVAL, 'katie15@naver.com', 'teddy25@naver.com', '욕설/비방', '심한 욕설을 하여 신고합니다.', SYSDATE, 'TESTBOARD'||'SEQ');
...
-- 신고하기 test
INSERT INTO REPORTBOARD(SEQ, REPORTER_EMAIL, SUBJECT_EMAIL, REPORT_TYPE, CONTENT, TEXT_REGDATE, PROCESSING_STATUS, BOARD_TYPE)
VALUES(REPORTBOARD_SEQ.NEXTVAL, 'user@naver.com', 'user2@naver.com', '욕설/비방', '심한 욕설을 하여 신고합니다.', SYSDATE, 'N', 'QUESTIONBOARD');
